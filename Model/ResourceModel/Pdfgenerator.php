...
namespace Eadesigndev\PdfGeneratorPro\Model\ResourceModel;
...
class Pdfgenerator extends AbstractDb
{
    ...
    {
        $this->_init('xtea_pdf_templates', 'template_id');
    }
    ...
    public function saveStoreRelation(AbstractModel $template)
    {
        ...
        $table = $this->getTable('xtea_pdf_store');
